  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-5 py-8">
      <section className="w-full max-w-5xl text-center">
        <p className="text-lg font-bold uppercase text-gold">From the Host</p>
        <h1 className="mt-4 text-4xl font-black text-champagne md:text-7xl">
          Tonight Was Never Just About Prizes
        </h1>
        <p className="mt-8 rounded-md border border-gold/30 bg-black/50 p-6 text-left text-xl leading-9 text-stone-100 shadow-gold md:p-10 md:text-3xl md:leading-[1.45]">
